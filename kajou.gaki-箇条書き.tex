...
1/F Jiu An Plaza, 258 Tongren Lu	& \textit{Mobile:} +86-158 0057 1080\\
200040 Shanghai	& \textit{E-mail:} \email{emil.rehnberg@gmail.com}\\
China
\end{tabular}
...
\textit{Programming:}
\begin{innerlist}
    \item Intermediate knowledge: R, SQL, Ruby, Ruby on Rails, SAS, shell scripting, CoffeeScript, JavaScript
