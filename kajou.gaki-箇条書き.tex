...
\item[] \textit{Senior Data Scientist - GFGO Blockchain \& Quantum}%
  \hfill \textbf{Oct 2024 to Present}
  \begin{innerlist}
  \item Data Scientist for COI Reporter (GenAI product)
  \item Data Scientist for ECA Optimizer
  \item Lead Data Scientist for Ericsson Demand Forecast Application
  \end{innerlist}

\item[] \textit{Lead Data Scientist - GFGO CIO \& Enterprise IT}%
  \hfill \textbf{Apr 2022 to Oct 2024}
  \begin{innerlist}
  \item Lead Data Scientist for Ericsson Demand Forecast Application
  \end{innerlist}

\item[] \textit{Lead Data Scientist - GIT A\&AI DS Chapter}%
  \hfill \textbf{Oct 2021 to Apr 2022}
  \begin{innerlist}
  \item Lead Data Scientist for Ericsson Demand Forecast Application
  \end{innerlist}

\item[] \textit{Data Scientist - GIT Data Migration Dept}%
  \hfill \textbf{June 17 2019 to Oct 2021}
  \begin{innerlist}
  \item Lead Data Scientist for Ericsson Demand Forecast Application
...
\textit{Statistics and Machine Learning:}
\begin{innerlist}
...
\begin{innerlist}
\item Azure Foundry and services, Snowflake, AWS SageMaker, DataBricks, Azure DevOps, JIRA, GitHub, GitLab
