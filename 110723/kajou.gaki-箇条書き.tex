...
Sk\"{o}ntorpsv\"{a}gen 102	& \textit{Mobile:} +46-730-550635 \\
12053 \AA rsta (Stockholm)	& \textit{E-mail:} \email{emil.rehnberg@gmail.com}\\
SWEDEN
\end{tabular}
...
\item[] \textit{Biostatistician}%
        \hfill \textbf{December 2009 to present}
\begin{innerlist}
...
\begin{innerlist}
    \item Epidemiology, descriptive statistics, multivariate analysis, analysis of cathegorical data, stochastic processes, probability theory, survival analysis.
\end{innerlist}
...
\textit{Programming:}
\begin{innerlist}
    \item Bash shell scripting, parallell computing, R, SAS.
\end{innerlist}
...
\begin{innerlist}
    \item Ubuntu, Microsoft Windows family, Apple OS X and other UNIX variants.
\end{innerlist}
